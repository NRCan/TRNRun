...
class Simulation:
    ...
    def mark_completed(self) -> None:
        """Record that the queue observed the runner process exit."""
        self._finished.set()

    def wait(self, timeout: float | None = None) -> bool:
        """Wait for the queue to report runner completion."""
    ...
    def is_finished(self) -> bool:
        """Return whether the queue reported runner completion."""
    ...
    def succeeded(self) -> bool:
        ...
        with self._lock:
            return self._finished.is_set() and self._status is not None and self._status.status == "DONE"
