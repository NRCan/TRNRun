...
function options = toolboxOptions()
    ...
    options = matlab.addons.toolbox.ToolboxOptions(toolboxFolder(), identifier, ...
        ...
        ToolboxImageFile=fullfile(rootFolder(), "images", "trnrun.png"), ...
...
function verifyTask(~)
    ...
    required = [ ...
        fullfile(toolboxFolder(), "bin", "trnrun.exe"); ...
        fullfile(toolboxFolder(), "bin", "trnrunq.exe"); ...
        ...
        fullfile(rootFolder(), "images", "trnrun.png") ...
    ];
...
function testTask(~)
    ...
    %   The tests need Windows and the bundled queue executable, but never
    %   TRNSYS.
